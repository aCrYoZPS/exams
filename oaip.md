...
Стек может быть как динамической так и статической структурой данных, в зависимости от того, с помощью чего он реализован. В программировании стек можно реализовывать разными способами, например:
...
Программная реализация стека на основе статического массива предполагает фиксированный его размер, однако она достаточно проста в реализации.
```cpp
class Stack {
private:
